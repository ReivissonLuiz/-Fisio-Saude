...
class _ProfessionalRegisterScreenState extends State<ProfessionalRegisterScreen> {
  ...
  @override
  void dispose() {
    [_nomeCtrl, _emailCtrl, _cpfCtrl, _crefitoCtrl, _telCtrl, _cepCtrl, _senhaCtrl, _confirmarCtrl]
        .forEach((c) => c.dispose());
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Cadastro — Fisioterapeuta'), leading: const BackButton()),
      body: SafeArea(
        child: Center(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.medical_services_rounded, color: AppTheme.secondary, size: 28),
                    ),
                    ...
                    const Column(
                      ...
                      children: [
                        ...
                        Text('Fisioterapeuta', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ],
                ),
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Seu cadastro passará por análise e será ativado após aprovação do administrador.',
                ...
                CustomTextField(
                  ...
                  validator: (v) => (v == null || _cpfMask.getUnmaskedText().length != 11) ? 'CPF inválido.' : null,
                ),
                const SizedBox(height: 14),
                ...
                CustomTextField(
                  ...
                  validator: (v) => (v == null || v.trim().isEmpty) ? 'Informe seu CREFITO.' : null,
                ),
                const SizedBox(height: 14),
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _especializacoes
                      ...
                      .toList(),
                  onChanged: (v) => setState(() => _especializacaoSelecionada = v),
                  validator: (v) => (v == null || v.isEmpty) ? 'Selecione uma especialização.' : null,
                ),
                const SizedBox(height: 20),
                ...
                CustomTextField(
                  ...
                  validator: (v) => (v == null || _cepMask.getUnmaskedText().length != 8) ? 'CEP inválido.' : null,
                ),
                const SizedBox(height: 20),
